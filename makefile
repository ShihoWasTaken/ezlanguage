...
MOD_CPP = src/modules/DeclarationFunction.cpp src/modules/DeclarationConstante.cpp src/modules/DeclarationType.cpp src/modules/DeclarationVariable.cpp src/modules/ArrayDeclaration.cpp src/modules/ArrayAccess.cpp src/modules/Condition.cpp src/modules/Conditionnal_instruction.cpp src/modules/If.cpp src/modules/Declaration.cpp src/modules/Foreach.cpp src/modules/Forall.cpp src/modules/Function.cpp src/modules/HashElement.cpp src/modules/HashTable.cpp src/modules/Instruction.cpp src/modules/Iterative_instruction.cpp src/modules/Node.cpp src/modules/Operator.cpp src/modules/Range.cpp src/modules/Repeat.cpp src/modules/ScopeHashTable.cpp src/modules/Variable.cpp src/modules/While.cpp
